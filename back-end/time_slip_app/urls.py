...
from .views import CreateTimeSlip, DeleteTimeSlip, ReviewTimeSlip, UpdateTimeSlip, GenerateAiTime, TimeSlipsByCar
...
urlpatterns = [
    ...
    path('all/car/<int:car_id>/', TimeSlipsByCar.as_view(), name="time_slips_by_car")
]